...
function hide() {
  imageClass.value = 'image-invisible';
}
...
<template>
  <img :src="blockImageUrl" class="block-overlay-image" :class="imageClass">
</template>
